    ...
    %if status == 'OK':
        ...
        <div class="main_box_right">
            ...
            <div class="compare_box">
                ...
                <a href=${allegro['url']}>
                    <img src="${request.static_path('myproject:static/allegro_nokaut_html-css/img/logo_allegro.png')}" alt="logo_allegro"/>
                </a>
            ...
            <div class="compare_box">
                 %if nokaut['status'] == 'OK':
                <a href=${nokaut['url']}>
                    <img src="${request.static_path('myproject:static/allegro_nokaut_html-css/img/logo_nokaut.png')}" alt="logo_nokaut"/>
                </a>
                ...
                %elif nokaut['status'] == 'NO_ITEM':
                    <img src="${request.static_path('myproject:static/allegro_nokaut_html-css/img/logo_nokaut.png')}" alt="logo_allegro"/>
